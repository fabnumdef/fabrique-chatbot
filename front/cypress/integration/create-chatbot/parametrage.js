describe('Testing first step of creating bot page', function () {
  ...
  describe('Filling contact information', () => {
    it('Should not have contact form in the beginning', function () {
      cy.get('[data-cy=UserForm]').should('not.exist');
    })

    it('Should have one form if we click add button', function () {
      cy.get('[data-cy=AddUserBtn]').click();
      cy.get('[data-cy=UserForm]').should('exist');
    })

    it('Should block second form if the first form is not valid', function () {
      ...
      cy.get('[data-cy=AddUserBtn]').should('be.disabled');
    })

    it('Should enable second form if the first form is valid', function () {
      cy.get('[data-cy=DeleteUserBtn]').click();
      cy.get('[data-cy=AddUserBtn]').click();
      cy.get('[data-cy=FirstNameInput]')
        .type('John')
      ...
      cy.get('[data-cy=AddUserBtn]').should('not.be.disabled');
    })
  })
});
